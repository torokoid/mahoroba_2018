...
body::before {
  ...
  width:100%;
  height:100vh;
  background:url(https://torokoid.github.io/mahoroba_2018/20180810_107.JPG) center/cover no-repeat; /*fixedをトル！*/
...
<p align="right"><marquee direction="left" scrollamount="10" width="100%">暑さの中、す～さんが極度の体調不良を押してご参加いただけました！</marquee></p>
<h3>2018年の記録</h3>
